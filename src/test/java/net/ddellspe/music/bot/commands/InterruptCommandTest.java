...
public class InterruptCommandTest {
  ...
  public void testGetName() {
    InterruptCommand cmd = new InterruptCommand();
    assertEquals("interrupt", cmd.getName());
  }
  ...
  public void testInVoiceChannelStartedAndQueues() {
    ...
    when(mockMessage.getContent()).thenReturn("!interrupt song");
    ...
    assertTrue(handler.shouldRequeueCurrent());
  }
}
